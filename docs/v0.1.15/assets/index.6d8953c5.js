import{m as p,F as k,M as w,u as s,a as c,l as y,s as h,y as m,v as b,S as g,W as f}from"./vendor.519a7843.js";const u=function(){const d=document.createElement("link").relList;if(d&&d.supports&&d.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function e(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerpolicy&&(a.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?a.credentials="include":n.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(n){if(n.ep)return;n.ep=!0;const a=e(n);fetch(n.href,a)}};u();var x=`## Markdown viewer [metaframe](https://metapages.org/)
...
`;const z=p({html:!0,linkify:!0,typographer:!0});let v=x;const M=()=>{const i=k(w),[d]=s("url"),[e]=c("base64"),[r,n]=y(""),a=h(null);return m(()=>{let o;return r===""&&!d&&!e&&(o=setTimeout(()=>{n(v)},200)),()=>{o&&clearTimeout(o)}},[d,e,r,n]),m(()=>{if(!i.inputs)return;var o=Object.keys(i.inputs)[0];if(!o)return;let t=i.inputs[o];if(t){try{o.endsWith("base64")&&(t=atob(t))}catch(l){n(`# Error atob from base64 metaframe input:

 - key: ${o}
 - value: ${t} 
 - err: ${l}`);return}n(t)}},[i.inputs,n]),m(()=>{!d||d===""||(async()=>{const o=await fetch(d);if(!o.ok){n(`# Error getting URL: ${d}

 - status: ${o.status}
 - statusText: ${o.statusText}`);return}const t=await o.text();n(t)})()},[d,n]),m(()=>{!e||e===""||n(e)},[e,n]),m(()=>{if(!(!r||r===""||!a?.current))try{var o=z.render(r);a.current.innerHTML=o}catch(t){n(`# Error rendering markdown 

 - markdown: \`${r}\` 
 - err: ${t}`)}},[r,a]),b("div",{ref:a})},I=()=>b(M,null);var Z=`.markdown-body .octicon {
...
`;g(b(f,null,b(I,null)),document.getElementById("root"));
//# sourceMappingURL=index.6d8953c5.js.map
